...
import { SingleProductApi } from "./Routes";
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col gap-5">
                            ...
                            <div className="flex gap-4 mt-2 flex-wrap">
                                <button className="flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-700 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 cursor-pointer shadow-md hover:shadow-lg flex-1 sm:flex-none">
